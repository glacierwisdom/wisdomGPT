...
- **资源获取**  
  ...
  **EmpatheticDialogues**  
<img src="_DocumentRSS/empathetic_dialogues.png" width="1200">
- **内容概述**  
...
- ​**学术支持**​  
  ...
  **DailyDialog**​  
  <img src="_DocumentRSS/DailyDialog.png" width="1200">  
- ​**内容概述**​  
  包含 ​**13,118**​ 个日常对话，总计 ​**102K**​ 条对话语句，标注了 ​**7**​ 种情感、**4**​ 类对话动作以及 ​**10**​ 个对话主题，适用于多种对话任务。

- ​**核心价值**​  
  ✅ ​**对话丰富**：涵盖日常生活的多样化场景，提供真实对话数据  
  ✅ ​**情感标注**：标注 7 种情感，支持情感识别与情感对话生成任务  
  ✅ ​**动作识别**：标注 4 类对话动作，适用于对话动作识别任务  
  ✅ ​**主题多样**：覆盖 10 个日常对话主题，满足多场景研究需求  
...
- ​**数据统计**​  
  ...
  情感、动作与主题示例：  
  ​**情感**：`快乐、悲伤、愤怒、惊讶、恐惧、厌恶、中立`  
  ​**对话动作**：`信息提供、问题提出、建议提供、其他动作`  
  ​**主题**：`旅行、购物、饮食、健康、娱乐、工作、教育、家庭、社交、其他`

- ​**学术支持**​  
  📜 [DailyDialog 论文](https://www.aclweb.org/anthology/I17-1099/)  
  *发表于 ACL，提供日常对话数据集的理论与应用研究*

- ​**资源获取**​  
  🔗 [项目地址](http://yanran.li/dailydialog)  
  📂 [数据集下载](http://yanran.li/dailydialog)


  **ESConv**​  
  <img src="_DocumentRSS/ESConv.png" width="1200">  
- ​**内容概述**​  
  包含 ​**1,053**​ 个情感支持对话，总计 ​**31,410**​ 条语句，标注了 ​**7**​ 种负向情绪、**5**​ 个负向情绪问题以及 ​**8**​ 种情感支持策略，专为情感支持对话（ESC）任务设计。

- ​**核心价值**​  
  ✅ ​**情感支持**：专注于情感支持场景，提供针对性对话数据  
  ✅ ​**情绪标注**：标注 7 种负向情绪，支持情绪识别与情感支持任务  
  ✅ ​**问题分类**：标注 5 个负向情绪问题，帮助理解情绪根源  
  ✅ ​**策略多样**：提供 8 种情感支持策略，适用于情感支持对话生成任务  
...
- ​**数据统计**​  
  ...
  负向情绪、问题与策略示例：  
  ​**负向情绪**：`悲伤、焦虑、愤怒、孤独、内疚、恐惧、无助`  
  ​**负向情绪问题**：`人际关系、工作压力、家庭矛盾、健康问题、其他问题`  
  ​**情感支持策略**：`共情、建议提供、情绪调节、问题解决、资源推荐、积极肯定、倾听、其他策略`

- ​**学术支持**​  
  📜 [ESConv 论文](https://arxiv.org/abs/2106.01144)  
  *发表于 arXiv，提出情感支持对话任务及相关数据集的理论与方法*

- ​**资源获取**​  
  🔗 [项目地址](https://github.com/thu-coai/Emotional-Support-Conversation)  
  📂 [数据集下载](https://github.com/thu-coai/Emotional-Support-Conversation)

**CPED**​  
  <img src="_DocumentRSS/CPED.png" width="1200">  
- ​**内容概述**​  
  包含 ​**12,000+**​ 段对话，整合了性别、大五人格特征、**13**​ 种情绪、**19**​ 种对话行为以及 ​**10**​ 个场景的多源知识，专注于中文个性化与情感对话生成任务。

- ​**核心价值**​  
  ✅ ​**多模态数据**：涵盖视频、音频和文本，提供丰富的数据来源  
  ✅ ​**个性与情感结合**：结合性别与大五人格特征，支持个性化对话生成  
  ✅ ​**情绪多样性**：标注 13 种情绪，增强情感对话生成的真实性  
  ✅ ​**场景丰富**：覆盖 10 个场景，满足多场景对话研究需求  
...
- ​**数据统计**​  
  ...
  情绪、对话行为与场景示例：  
  ​**情绪**：`快乐、悲伤、愤怒、惊讶、恐惧、厌恶、中立、焦虑、兴奋、沮丧、内疚、羞耻、其他`  
  ​**对话行为**：`信息提供、问题提出、建议提供、情绪表达、请求、确认、拒绝、其他行为`  
  ​**场景**：`家庭、工作、社交、教育、娱乐、购物、旅行、健康、其他场景`

- ​**学术支持**​  
  📜 [CPED 论文](https://arxiv.org/pdf/2205.14727v1.pdf)  
  *发表于 arXiv，提出中文个性化与情感对话数据集的理论与方法*

- ​**资源获取**​  
  🔗 [项目地址](https://github.com/scutcyr/CPED)  
  📂 [数据集下载](https://github.com/scutcyr/CPED)  
  📝 [任务设置](https://paperswithcode.com/dataset/cped)
